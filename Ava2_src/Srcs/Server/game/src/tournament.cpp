...
static LPEVENT m_pkTournamentEvent = NULL;
...
static const char* LC_TRANSLATE(const char* key) /* Configurable */
{
	...
	LC_TRANSLATE["TOURNAMENT_CATEGORY_LOW"]								= "Low";	
	LC_TRANSLATE["TOURNAMENT_CATEGORY_MEDIUM"]							= "Medium";	
	LC_TRANSLATE["TOURNAMENT_CATEGORY_HARD"]							= "Hard";

	LC_TRANSLATE["TOURNAMENT_TEAM_MEMBER_RED"]							= "Red";		
	LC_TRANSLATE["TOURNAMENT_TEAM_MEMBER_BLUE"]							= "Blue";	
	
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_BEFORE_START"]				= "<Tournament PvP> Category %s will start in %d minutes.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_1"]				= "<Tournament PvP> Category %s has started, good luck to the two teams.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_2"]				= "<Tournament PvP> the fight duration is %d minutes.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_START_LINE_3"]				= "<Tournament PvP> To spectate the fights just click on the quest from the left.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_NOT_STARTED_LINE_1"]			= "<Tournament PvP> The number of players is insufficient for [%s] category, because of that the fight can't start.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_NOT_STARTED_LINE_2"]			= "<Tournament PvP> At %s, category [%s] will start.";
	
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_FINISHED_LINE_1"]				= "<Tournament PvP> Category %s has ended.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_FINISHED_LINE_2"]				= "<Tournament PvP> At %s, category [%s] will start.";

	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_SAME"]					= "<Tournament PvP> The fight ended in a draw, both teams has the same number of members left standing.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_NOT_EXIST"]			= "<Tournament PvP> No team has won the tournament, because there were no members left standing.";
	LC_TRANSLATE["TOURNAMENT_ANNOUNCEMENT_WINNER_SUCCES"]				= "<Tournament PvP> Congratulations to %s team, the team won the tournament with %d members left standing.";

	LC_TRANSLATE["TOURNAMENT_MEMBER_REMAINING_LIFE"]					= "<Tournament PvP> You have %d lifes.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_FINISHED_LIFE_LINE_1"]				= "<Tournament PvP> You dont have any lifes left.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_FINISHED_LIFE_LINE_2"]				= "<Tournament PvP> You have been eliminated from the tournament, next time be more prepared!";
	LC_TRANSLATE["TOURNAMENT_MEMBER_DIVIDED"]							= "<Tournament PvP> You have been assigned to %s team.";

	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_DUEL"]						= "<Tournament PvP> You can't challenge to a duel in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_PARTY"]						= "<Tournament PvP> You can't use party in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_RING_MARRIAGE"]				= "<Tournament PvP> You can't use the wedding ring in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_POLY"]						= "<Tournament PvP> You can't.transform in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_CHANGE_PKMODE"]				= "<Tournament PvP> You can't use the PVP options in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_MOUNT"]						= "<Tournament PvP> You can't ride a mount in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_HORSE"]						= "<Tournament PvP> You can't ride a horse in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_EXIT_OBSERVER_MODE_LINE_1"]	= "<Tournament PvP> You can't change the observator mod in this map.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_BLOCK_EXIT_OBSERVER_MODE_LINE_2"]	= "<Tournament PvP> If you want to exit the map use the quest from the left.";
	
	LC_TRANSLATE["TOURNAMENT_MEMBER_OPEN_REWARD_WRONG_SIZE"]			= "<Tournament PvP> You can't use this because you need to have minimum %d slots free in inventory.";	
	LC_TRANSLATE["TOURNAMENT_MEMBER_CANNOT_USE_ITEM"]					= "<Tournament PvP> You can't use item %s because is restricted.";	
	LC_TRANSLATE["TOURNAMENT_INSERT_LOG_WINNERS"]						= "Name: %s | Level: %d | IP: %s | Remaining life: %d | Team: %s";	
	
#ifdef ENABLE_EXTRA_LIVES_TOURNAMENT
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_1"]		= "<Tournament PvP> You can't use this item here, need to do that before to be here.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_2"]		= "<Tournament PvP> You already did that recent, can't make again so fast, you need to finish all extra lifes.";
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_ERROR_LINE_3"]		= "<Tournament PvP> Total extra life remaining: %d from %d.";	
	LC_TRANSLATE["TOURNAMENT_MEMBER_ADD_EXTRA_LIVES_SUCCES"]			= "<Tournament PvP> Congratulations, was added +%d life in tournament, them are available for %d times participation's.";	
#endif
...
const int TOURNAMENT_INFO_TIMER[TOURNAMENT_MAX_CATEGORY][4] = /* Configurable */
{
	...
	*/
	{ 02, 10,	02, 40 }, // TOURNAMENT_CATEGORY_LOW
	{ 15, 30,	16, 00 }, // TOURNAMENT_CATEGORY_MEDIUM
	{ 19, 25,	20, 25 }  // TOURNAMENT_CATEGORY_HARD
};
...
void CTournamentPvP::WriteStatus(int iStatus)
{
	quest::CQuestManager::instance().RequestSetEventFlag("tournament_event", iStatus);
}
...
void CTournamentPvP::PrepareAnnouncement()
{
	...
	{
		if (vKey.tm_hour == TOURNAMENT_INFO_TIMER[keyIndex - 1][0] - 1 && vKey.tm_min == TOURNAMENT_INFO_TIMER[keyIndex - 1][1])
		{
...
{
	int iLeftTime = (TOURNAMENT_INFO_TIMER[key - 1][3] - TOURNAMENT_INFO_TIMER[key - 1][1]);
	return std::abs(iLeftTime);
}
...
bool CTournamentPvP::Initialize()
{
	...
	if (m_pkTournamentEvent)
	{
		event_cancel(&m_pkTournamentEvent);
		m_pkTournamentEvent = NULL;
	}
	...
	if (g_bChannel == TOURNAMENT_NEED_CHANNEL)
	{
		TournamentPvPInfoData* info = AllocEventInfo<TournamentPvPInfoData>();
		info->pTournament = this;
		m_pkTournamentEvent = event_create(tournament_timer, info, PASSES_PER_SEC(30));
	}
...
{
	int iRandom = number(0, 2);
	ch->WarpSet(g_observers_position_tournament[iRandom][0], g_observers_position_tournament[iRandom][1]);
}
