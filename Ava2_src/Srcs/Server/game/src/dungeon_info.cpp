...
void CDungeonInfoExtern::SetInfoRanking(LPCHARACTER ch, int map_index)
{
	...
	{ 
		...
		std::auto_ptr<SQLMsg> pmsg1(DBManager::instance().DirectQuery(InsertSql));
	}
...
bool CDungeonInfoExtern::CheckTimeDungeonRoom(LPCHARACTER ch, long index_map)
{
	...
	char dungeon_time_room[1024];
	snprintf(dungeon_time_room, sizeof(dungeon_time_room), "dungeon_info.dungeon_time_room_%d", index_map);
...
void CDungeonInfoExtern::SetTimeDungeonRoom(LPCHARACTER ch, long index_map)
{
	...
	char dungeon_time_respawn[1024];
	snprintf(dungeon_time_respawn, sizeof(dungeon_time_respawn), "dungeon_info.dungeon_time_respawn_%d", index_map);
	...
	snprintf(fix_item_check, sizeof(fix_item_check), "dungeon_info.fix_item_check_%d", index_map);
...
int CDungeonInfoExtern::GetTimeFinishTotalDungeon(LPCHARACTER ch, long index_map)
{
	...
	char dungeon_time_finish[1024];
	snprintf(dungeon_time_finish, sizeof(dungeon_time_finish), "dungeon_info.dungeon_time_finish_w_%d", index_map);
